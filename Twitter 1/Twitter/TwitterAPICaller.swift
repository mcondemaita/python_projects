...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "skYJjOOGT6VvQSJsSE7QBM3CL", consumerSecret: "TWTdNggMEtpSuu2bccyCiTz9fKlU1QUrTjfSoPUDQQKa8EFXkg")
    var loginSuccess: (() -> ())?
